...
//black box start
 ...
 /// rod 2 start      
   ...
   paper.path("M"+(x + 55)+","+(y + 45)+"l 70 -8 50 0").attr({
    ...
    paper.image('simulation/images/final PCB.PNG', (x + 200), (y + 180), 200, 60);
    
    //Image of cad model
    txt1 = paper.text((x + 1000), (y - 160), "CAD model of given PCB").attr({
		stroke : 'black',
		'font-size' : 30,
		"font-family": "sans-serif" 
	});    
    cadmodelImg = paper.image('simulation/images/CADmodelPCB.PNG', (x + 800), (y - 140), 500, 300);
    
    
    
    // Img of tool path of given model
    txt2 = paper.text((x + 1020), (y + 250), "Vectorized model of given PCB").attr({
		stroke : 'black',
		'font-size' : 30,
		"font-family": "sans-serif" 
	});    
    tollpathImg = paper.image('simulation/images/VectorizedSample.PNG', (x + 800), (y + 300), 500, 300);
...
function stopcutting(){
    ...
    txt3 = paper.text((x + 1020), (y - 160), "Final product view").attr({
		stroke : 'black',
		'font-size' : 30,
		"font-family": "sans-serif" 
	});    
    finalProduct = paper.image('simulation/images/final PCB.PNG', (x + 800), (y - 140), 500, 300);
